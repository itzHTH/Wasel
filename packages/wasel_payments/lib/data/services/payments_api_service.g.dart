...
class _PaymentsApiService implements PaymentsApiService {
  _PaymentsApiService(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<TokenizeCardResponse> tokenizeCard(
    ...
    final _options = _setStreamType<TokenizeCardResponse>(
    ...
    late TokenizeCardResponse _value;
    try {
      _value = TokenizeCardResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
