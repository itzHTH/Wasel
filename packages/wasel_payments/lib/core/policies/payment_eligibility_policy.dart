...
abstract final class PaymentEligibilityPolicy {
  static const String missingCardMessage = 'أضف بطاقة قبل تأكيد الطلب';

  static const String insufficientWalletMessage =
  ...
  static String? blockerFor({
    required PaymentMethod method,
    String? token,
    double? balance,
    num? fare,
  }) {
    if (requiresCard(method, token)) return missingCardMessage;
    ...
    return balance < fare ? insufficientWalletMessage : null;
  }
}
