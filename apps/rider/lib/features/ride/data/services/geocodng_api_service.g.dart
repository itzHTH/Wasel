...
part of 'geocodng_api_service.dart';
...
class _GeocodngApiService implements GeocodngApiService {
  _GeocodngApiService(this._dio, {this.baseUrl, this.errorLogger});
...
final class GeocodingApiServiceProvider
    extends
        $FunctionalProvider<
          ...
          GeocodngApiService
        >
    with $Provider<GeocodngApiService> {
  ...
  @$internal
  @override
  $ProviderElement<GeocodngApiService> $createElement(
    $ProviderPointer pointer,
  ) => $ProviderElement(pointer);

  @override
  GeocodngApiService create(Ref ref) {
    return geocodingApiService(ref);
  }

  /// {@macro riverpod.override_with_value}
  Override overrideWithValue(GeocodngApiService value) {
    return $ProviderOverride(
      origin: this,
      providerOverride: $SyncValueProvider<GeocodngApiService>(value),
    );
  }
}

String _$geocodingApiServiceHash() =>
    r'5608be5560da85437f4cabe28091f81dbabea1b0';
