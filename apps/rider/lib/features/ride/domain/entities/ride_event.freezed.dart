...
class DriverDisconnected implements RideEvent {
...
@override
String toString() {
  return 'RideEvent.driverDisconnected(rideId: $rideId, message: $message)';
}
...
/// @nodoc
abstract mixin class $DriverDisconnectedCopyWith<$Res> implements $RideEventCopyWith<$Res> {
...
class RideStatusSync implements RideEvent {
...
@override
String toString() {
  return 'RideEvent.statusSync(ride: $ride)';
}
...
/// @nodoc
abstract mixin class $RideStatusSyncCopyWith<$Res> implements $RideEventCopyWith<$Res> {
