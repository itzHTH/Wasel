...
@override
String toString() {
  return 'DriverRideEvent.receiveRideRequest(rideId: $rideId, position: $position, dropPosition: $dropPosition, calculatedPrice: $calculatedPrice, paymentMethod: $paymentMethod, message: $message)';
}
...
@useResult
$Res call({
 String rideId, GeoPoint position, GeoPoint dropPosition, double calculatedPrice, String paymentMethod, String message
});
